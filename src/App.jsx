...
<div style={{
    ...
    {`
      ...
      @keyframes glowing {
        ...
        50% {
          filter: drop-shadow(0 0 20px rgba(216, 67, 21, 0.8)) drop-shadow(0 0 40px rgba(216, 67, 21, 0.8)) drop-shadow(0 0 60px rgba(216, 67, 21, 0.8)) drop-shadow(0 0 80px rgba(216, 67, 21, 0.8));
        }
        100% {
          filter: drop-shadow(0 0 25px rgba(255, 87, 34, 0.8)) drop-shadow(0 0 100px rgba(255, 87, 34, 0.8)) drop-shadow(0 0 20px rgba(255, 87, 34, 0.8)) drop-shadow(0 0 30px rgba(255, 87, 34, 0.8));
        }
      }
    `}
  </style>
